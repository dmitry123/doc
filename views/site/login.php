...
<div class="input-group input-group-lg block-field">
	...
	<input id="login" type="text" name="UserForm[login]" class="form-control" placeholder="Логин или Email" aria-describedby="addon-login">
</div>
<div class="input-group input-group-lg block-field">
	<span class="input-group-addon glyphicon glyphicon-lock" id="addon-password"></span>
	<input id="password" type="password" name="UserForm[password]" class="form-control" placeholder="Пароль" aria-describedby="addon-password">
</div>
